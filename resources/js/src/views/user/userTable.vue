    ...
    <div class="panel pb-0">
      ...
      <div class="table-responsive">
        <table class="table-hover">
          ...
          <tbody v-if="userStore.$state.isLoading || isLoading">
            <tr>
              <td colspan="7">
                <Spinner
          ...
          <tbody v-else-if="userStore.$state.user.data.length === 0">
            <tr>
              <td colspan="7">
                <div
          ...
          <tbody v-else>
            <tr v-for="user in userList" :key="user.id">
              <td class="border-b p-2">{{ user.branch.name }}</td>
              <td
              ...
              <td class="border-b p-2">{{ user.profile }}</td>
      ...
      <div
        v-show="!userStore.$state.isLoading"
        class="flex justify-between items-center mt-5"
      >
        <nav
          v-if="userStore.$state.user.total > userStore.$state.user.limit"
          class="relative z-0 inline-flex justify-center rounded-md shadow-sm -space-x-px"
          aria-label="Pagination"
        >
          <a
            v-for="(link, i) of userStore.$state.user.links"
            :key="i"
            :disabled="!link.url"
            href="#"
            ...
            :class="[
              ...
              i === 0 ? 'rounded-l-md' : '',
              i === userStore.$state.user.links.length - 1
                ? 'rounded-r-md'
                : '',
...
const userList = computed(() => userStore.$state.user.data);
...
const userAddress = ref({ ...DEFAULT_ADDRESS_OBJECT });
