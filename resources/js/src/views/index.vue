    ...
    <div class="pt-5">
      <div class="grid xl:grid-cols-2 gap-6 mb-6">
        <div class="panel h-full p-0">
          <div class="flex items-center w-full p-5 absolute">
            <div class="relative">
              <div
              ...
              >
                <v-icon name="md-attachmoney-twotone" scale="1.5" />
              </div>
            </div>
            <div class="ml-3">
              <h5 class="font-semibold text-2xl dark:text-white-light">
                R$ 15.234,98
                <span class="block text-sm font-normal"
                  >Faturamento 05/2023</span
                >
              </h5>
            </div>
          </div>
        ...
        <div class="panel h-full p-0">
          <div class="flex p-5">
            ...
            >
              <v-icon name="md-iron-outlined" scale="1.5" />
            </div>
            <div class="ltr:ml-3 rtl:mr-3 font-semibold">
              <p class="text-xl dark:text-white-light">3763</p>
              <span class="block text-sm font-normal dark:text-white-light"
                >Peças Feitas</span
              >
            </div>
          </div>
        ...
        <div class="panel h-full w-full">
          ...
          <div class="table-responsive">
            <table>
              <thead>
                <tr>
                  <th class="rounded-l-md">Código do ROL</th>
                  <th>Cliente</th>
                  <th>Dt de envio</th>
              ...
              <tbody>
                ...
                >
                  <td>
                    <router-link to="#"
                      >56fc1a9a-378c-48c5-a0cf-224faec812a0</router-link
                    >
                  </td>
                  <td>Justino Anastácia</td>
                  <td>
                    <router-link to="/apps/invoice/preview">#46894</router-link>
                  </td>
                  <td>
                    <span
                      class="badge bg-warning shadow-md dark:group-hover:bg-transparent"
                      >Enviado</span
                    >
                  </td>
                </tr>
                ...
                >
                  ...
                  <td>Jorge Jerônimo</td>
                  <td>
                    <router-link to="/apps/invoice/preview">#76894</router-link>
                  </td>
                  <td>
                    <span
                ...
                >
                  <td>
                    <router-link to="#"
                      >104e4a3e-5259-41bc-8e7c-9dadcaec5fde</router-link
                    >
                  </td>
                  <td>Rubina Toni</td>
                  <td>
                    <router-link to="/apps/invoice/preview">#66894</router-link>
                  </td>
                  <td>
                    <span
                      class="badge bg-warning shadow-md dark:group-hover:bg-transparent"
                ...
                >
                  <td>
                    <router-link to="#"
                      >7066a09a-fc1d-4915-a8c0-a0c20dcfc23b</router-link
                    >
                  </td>
                  <td>Dan Jeremias</td>
                  <td>
                    <router-link to="/apps/invoice/preview">#75844</router-link>
                  </td>
                  <td>
                    <span
                      class="badge bg-danger shadow-md dark:group-hover:bg-transparent"
                      >Cancelado</span
                    >
                  </td>
                </tr>
      ...
      <div class="grid grid-cols-1 xl:grid-cols-2 gap-6 mb-6">
        <div class="panel pb-0">
          <div class="flex md:items-center md:flex-row flex-col mb-5 gap-5">
            <h5 class="font-semibold text-lg dark:text-white-light">
              Agenda do dia - Eventos pendentes
            </h5>
            <div class="ml-auto">
              <input
                v-model="search2"
          ...
          <div class="datatable">
            <vue3-datatable
              ...
              :search="search2"
              paginationInfo="Mostrando {0} a {1} no total de {2} registros"
              skin="table-hover"
