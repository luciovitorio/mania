    ...
    <div class="panel pb-0">
      ...
      <div class="table-responsive">
        <table class="table-hover">
          ...
          <tbody v-if="clothStore.$state.isLoading || isLoading">
            <tr>
              <td colspan="5">
                <Spinner
          ...
          <tbody v-else-if="clothStore.$state.cloth.data.length === 0">
            <tr>
              <td colspan="5">
                <div
          ...
          <tbody v-else>
            <tr v-for="cloth in clothList" :key="cloth.id">
              <td class="border-b p-2">{{ cloth.name }}</td>
              <td
              ...
              <td class="border-b p-2">
                <span :class="getStatusClass(cloth.type)">{{
                  cloth.type
                }}</span>
              </td>
              <td class="border-b p-2">
      ...
      <div
        v-show="!clothStore.$state.isLoading"
        class="flex justify-between items-center mt-5"
      >
        <nav
          v-if="clothStore.$state.cloth.total > clothStore.$state.cloth.limit"
          class="relative z-0 inline-flex justify-center rounded-md shadow-sm -space-x-px"
          aria-label="Pagination"
        >
          <a
            v-for="(link, i) of clothStore.$state.cloth.links"
            :key="i"
            :disabled="!link.url"
            href="#"
            ...
            :class="[
              ...
              i === 0 ? 'rounded-l-md' : '',
              i === clothStore.$state.cloth.links.length - 1
                ? 'rounded-r-md'
                : '',
...
import ClothModal from "./clothModal.vue";

useMeta({ title: "Roupas" });
...
const getStatusClass = (type) =>
  type === "FÁCIL" ? "badge bg-success" : "badge bg-danger";
...
async function deleteCloth(cloth) {
  Swal.fire({
    icon: "question",
    title: `Deseja excluir a filial ${cloth.name}?`,
